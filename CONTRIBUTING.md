...
3. Copy `.env.example` to `.env.local` and add your own `DATABASE_URL` and app secrets.
...
- Do not include personal data, database URLs, `.env.local`, generated build output, or local tool settings.
