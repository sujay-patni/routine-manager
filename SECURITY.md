...
Routine Manager is a self-hosted personal app. Please do not publish a deployment that contains real routine data unless it is protected by your hosting provider and a strong `APP_PASSPHRASE`.
...
- Whether the issue exposes routine data, authentication cookies, or secrets.
